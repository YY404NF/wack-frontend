...
export function useApp() {
  ...
  studentState = useStudentState({
    me,
    activeTab: appRouting.activeStudentTab,
    setActiveTab: appRouting.setActiveStudentTab,
    showScopedToast,
    changePassword,
    openPasswordModal,
    closePasswordModal,
  ...
  adminState = useAdminState({
    ...
    route,
    me,
    activeTab: appRouting.activeAdminTab,
    passwordForm,
    passwordModalOpen,
    passwordSaving,
    showScopedToast,
    setActiveTab: appRouting.setActiveAdminTab,
  ...
  const appSession = useAppSession({
    router,
    me,
    activeAdminTab: appRouting.activeAdminTab,
    activeStudentTab: appRouting.activeStudentTab,
    booting,
    initialized,
    authLoading,
    setupLoading,
    ...
    setupForm,
    loadRoleData,
    resolveAdminTab: appRouting.resolveAdminTab,
    resolveStudentTab: appRouting.resolveStudentTab,
    setActiveAdminTab: appRouting.setActiveAdminTab,
    setActiveStudentTab: appRouting.setActiveStudentTab,
    clearAllNotices,
    resetAppData,
    closeAllAdminModals,
  })
